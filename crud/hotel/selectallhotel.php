                 ...
                 <ul>
                     ...
                     <li class="drop-down"><a href="#">Consulta</a>
                         <ul>
                             ...
                             <li> <a class="dropdown-item" href="selectonehotel.php">hotel</a></li>
                             ...
                             <div class="portfolio-wrap">
                                 ...
                                 <div class="portfolio-info">
                                     ...
                                     <div class="portfolio-links">
                                         ...
                                         <a href="infohotel.php?id=<?php echo $dados["idhotel_h"]; ?>" title="More Details"><i class="icofont-external-link"></i></a>
                                     </div>
                                 </div>
                             </div>
                         </div>
