 <?php
  ...
  $idhotel = $_GET["idhotel_hotel"];
  $selectone = new Manipulacao();
  $selectone->setTabela("hotel");
  $selectone->setValorNaTabela("idhotel");
  $selectone->setValorPesquisa("$idhotel");
         ...
         <ul>
           ...
           <li class="drop-down"><a href="#">Cadastrar</a>
             <ul>
               ...
               <li> <a class="dropdown-item" href="../municipio/formmunicipio.php">municipio</a></li>
               ...
               <li> <a class="dropdown-item" href="formhotel.php">hotel</a></li>
         ...
         <div class="row">
           <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300" class="php-email-form">
             <div class="card" style="margin-top:20px">
               ...
               <div class="card-body">
                 <form action="../../crud/hotel/updatehotel.php" method="post" enctype="multipart/form-data">
                   <fieldset>

                     <input type="hidden" name="idhotel" value="<?php echo $row['idhotel'] ?>">
                     <div class="form-row">
                       <div class="col-md-6 mb-3">
                         <input class="form-control" type="text" required name="nomeHotel" id="nomeHotel" value="<?php echo $row["nomeHotel"] ?>" placeholder="Preencha este Campo com nomeHotel">
                       </div><br>
                       <div class="col-md-6 mb-3">
