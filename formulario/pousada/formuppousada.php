 <?php
  ...
  $selectone->setValorPesquisa("$idpousada");
         ...
         <ul>
           ...
           <li class="drop-down"><a href="#">Cadastrar</a>
             <ul>
               ...
               <li> <a class="dropdown-item" href="formpousada.php">pousada</a></li>
         ...
         <div class="row">
           <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300" class="php-email-form">
             <div class="card" style="margin-top:20px">
               ...
               <div class="card-body">
                 <form action="../../crud/pousada/updatepousada.php" method="post" enctype="multipart/form-data">
                   <fieldset>

                     <input type="hidden" name="idpousada" value="<?php echo $row['idpousada'] ?>">
                     <div class="form-row">
                       <div class="col-md-6 mb-3">
                         <input class="form-control" type="text" required name="nomePousada" id="nomePousada" value="<?php echo $row["nomePousada"] ?>" placeholder="Preencha este Campo com nomePousada">
                       </div><br>
                       <div class="col-md-6 mb-3">
